window.gml_Script_gmlcallback_setScaling();
...
function ImageLoadBar_hook(ctx, width, height, total, current, image) {
  ...
  var loading_canvas = document.getElementById("loading_screen");
  loading_canvas.width = canvas.width;
  loading_canvas.height = canvas.height;
